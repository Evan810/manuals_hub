...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff176584),
      surfaceTint: Color(0xff176584),
      ...
      secondaryFixedDim: Color(0xffb5cad7),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff176584),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff2d7493),
      ...
      inverseSurface: Color(0xff2c3134),
      inversePrimary: Color(0xff8dcff1),
      primaryFixed: Color(0xff2d7493),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff015c7a),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff22353f),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      inversePrimary: Color(0xff176584),
      primaryFixed: Color(0xffc1e8ff),
      onPrimaryFixed: Color(0xff001e2b),
      primaryFixedDim: Color(0xff8dcff1),
      onPrimaryFixedVariant: Color(0xff004d66),
